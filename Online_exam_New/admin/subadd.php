...
echo "<BR><h2 class=head1><u>Add Subject </u></h2>";
...
<form name="form1" method="post" onSubmit="return check();">
  <table class="tg" width="41%"  border="0" align="center">
    <tr>
      <td width="45%" height="32"><div align="center" class="tg-yw4l"><strong>Enter Subject Name </strong></div></td>
      <td width="2%" height="5">  
      <td width="53%" height="32">
        <input class="tg-yw4l" name="subname" placeholder="Enter Here" type="text" id="subname">
    <tr>
        <td height="26"> </td>
        <td>&nbsp;</td>
	  <td>&nbsp;</td>
    ...
    <tr>
      <td height="26"></td>
      <td>&nbsp;</td>
      <td><input class="myButton2" type="submit" name="submit" value="Add" ></td>
    </tr>
  </table>
</form>
<p>&nbsp; </p>
